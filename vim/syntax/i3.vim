...
" Config commands
syn keyword i3ConfigCommand focused unfocused urgent focused_inactive placeholder gaps smart_gaps bind bindcode bindsym assign new_window popup_during_fullscreen font floating_modifier default_orientation workspace_layout for_window focus_follows_mouse bar position colors output tray_output tray_padding workspace_buttons workspace_auto_back_and_forth binding_mode_indicator debuglog floating_minimum_size floating_maximum_size force_focus_wrapping force_xinerama force_display_urgency_hint hidden_state modifier new_float shmlog socket_path verbose mouse_warping strip_workspace_numbers focus_on_window_activation no_focus
syn match   i3IpcSocket "ipc[-_]socket" nextgroup=@i3String skipwhite

" Command keywords
syn keyword i3Command inner outer exit reload restart kill fullscreen global layout border focus move open split append_layout mark unmark resize grow shrink show nop rename title_format sticky
...
syn match i3ColorDef3 "client\.\(background\|focused_inactive\|focused\|unfocused\|urgent\)\|binding_mode\|inactive_workspace\|urgent_workspace\|focused_workspace\|active_workspace" nextgroup=i3Color1st skipwhite
